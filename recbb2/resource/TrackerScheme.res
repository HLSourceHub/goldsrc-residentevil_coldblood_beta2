...
Scheme
{
	...
	Colors
	{
		...
		"DimBaseText"		"160 0 0 255"	// dim base text
		"LabelDimText"		"160 0 0 255"	// used for info text
		"ControlText"		"200 0 0 255"	// used in all text controls
		"BrightControlText"	"180 0 0 255"	// use for selected controls
		"DisabledText1"		"60 0 0 255"	// disabled text
		"DisabledText2"		"40 0 0 255"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"117 0 0 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"0 0 0 255"		// background color of controls
	       //"ControlBG"			"0 0 0 255"		// background color of controls
		"ControlDarkBG"		"90 0 0 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"0 0 0 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"149 0 0 255"	// background color of any selected text or menu item
		"SelectionBG2"		"40 0 0 255"		// selection background in window w/o focus
		"ListBG"			"32 32 32 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"255 0 0 0"
		"TitleDimText"		"136 0 0 0"
		"TitleBG"			"0 0 0 0"
		"TitleDimBG"		"0 0 0 0"
...
//		"ButtonDepressedBgColor"
		...
		InGameDesktop
		{
			"MenuColor"			"192 192 192 255"
			"ArmedMenuColor"	"128 0 0 255"
